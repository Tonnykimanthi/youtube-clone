...
const Search = () => {
  return (
    <div className="flex gap-x-5 w-2/4">
      <div className="w-full h-10 grid grid-cols-7 border border-white/30 rounded-full overflow-hidden">
        ...
        <button className="h-full grid place-items-center bg-white/20 hover:bg-white/30 transition">
